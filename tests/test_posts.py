...
@pytest.mark.parametrize("title, content, published",[
    ...
    ("faviourite pizza", "i love veggie", False),
    ("tallest skyscapper", "wahoo", True)
])
...
def test_create_post_default_published_true(authorized_client, test_user, test_posts):
    res = authorized_client.post("/posts", json={"title": "arbitrary title", "content": "something-something"})
...
def test_unauthorized_user_create_post(client, test_user, test_posts):
    res = client.post("/posts", json={"title": "arbitrary title", "content": "something-something"})
    assert res.status_code == 401
